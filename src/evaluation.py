...
def plot_top_words_map(model, popular_words: int, word_counts: dict):
    ...
    fig.write_html("top_words_map.docs")
    fig.show()
...
def plot_example_cluster(model):
    ...
    fig.write_html("clusters_map.docs")
    fig.show()
...
def plot_capital_relationships(model):
    ...
    fig.show()
    fig.write_html("capital_relationships.docs")
...
def plot_comparative_relations(
    ...
    fig.show()
    fig.write_html("comparative_relations.docs")
...
def plot_plural_relations(
    ...
    fig.show()
    fig.write_html("plural_relations.docs")